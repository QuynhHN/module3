create database `ss4_bai_tap_quan_ly_sinh_vien`;
...
insert into student(student_name,address,phone,`status`,class_id) values ('Hung', 'Ha Noi', '0912113113', 1, 1),('Hoa', 'Hai phong',null, 1, 1),('Manh', 'HCM', '0123123123', 0, 2);
...
drop database `ss4_bai_tap_quan_ly_sinh_vien`;